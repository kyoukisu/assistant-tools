# pyright: reportMissingTypeStubs=false, reportGeneralTypeIssues=false, reportUnusedFunction=false
...
_daemon_client: TelegramClient | None = None


def _set_daemon_client(client: TelegramClient | None) -> None:
    global _daemon_client
    _daemon_client = client


def _get_daemon_client() -> TelegramClient | None:
